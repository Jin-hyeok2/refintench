...
class KafkaConfig {
    ...
    fun producerFactory(): ProducerFactory<String, String> {
        val configurationProperties: MutableMap<String, Any> = HashMap()
        ...
        val defaultKafkaProducerFactory = DefaultKafkaProducerFactory<String, String>(configurationProperties)
